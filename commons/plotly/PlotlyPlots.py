...
class PlotlyPlots:
    ...
    def create_line_plot_dash(self, data, x_axis_title, y_axis_title):
        return dcc.Graph(id='timeseries',
                         config={'displayModeBar': False},
                         animate=True,
                         figure={
                             'data': data,
                             'layout': self.get_plotly_layout(x_axis_title, y_axis_title)
                         })

    def create_line_plot(self, x=None, y=None, line_name=None, line_color=None, line_width=1.5, show_legend=True):
        if x is None:
    ...
    def get_layout_density(self, x_axis_title, y_axis_title):
        layout = {
            "font": {
                "size": 12,
                "family": 'Calibri',
    ...
    def create_heatmap(self, x=None, y=None, z=None):
        data = [
            go.Heatmap(
                z=z,
                x=x,
    ...
    def create_annotated_heatmap(self, x=None, y=None, z=None):
